...
$('.form-control').focus(function () {
  $(this).parent().prev('label').css({ color: '#3ee664' });
})
// city search
$(function (){
...
$('.form-control').on('blur',function(){
  if($(this).val() == ''){
    ...
    $(this).parent().next('.hotel-contact-details').show();
...
// close bui banner hurghada hotels page
$(document).on('click', '.entire-homes-aparts .close', function() {
  $(this).parent().hide();
});
